...
//	//printf("a: ");
	...
	//	HMC58X3_writeReg(HMC58X3_R_CONFA,DOR<<2);
		...
		HAL_I2C_Mem_Write(&hi2c1,HMC58X3_ADDR,HMC58X3_R_CONFB, I2C_MEMADD_SIZE_8BIT, &cdata[1], 1, 1000);       //设置增益，      
    HAL_I2C_Mem_Write(&hi2c1,HMC58X3_ADDR,HMC58X3_R_MODE, I2C_MEMADD_SIZE_8BIT, &cdata[2], 1, 1000);     //设置测量模式，连续测量模式
		HAL_I2C_Mem_Write(&hi2c1,HMC58X3_ADDR,HMC58X3_R_CONFB, I2C_MEMADD_SIZE_8BIT, 0x00, 1, 1000);       //设置增益，    
    HMC58X3_FIFO_init();
}
